    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          ...
          {user?.admin && (
            <>
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Administração</h3>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <button
                    ...
                    className="group p-6 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-gradient-to-br hover:from-blue-50 hover:to-blue-100 transition-all duration-300 ease-in-out text-left transform hover:scale-105 hover:shadow-lg active:scale-95"
                  >
