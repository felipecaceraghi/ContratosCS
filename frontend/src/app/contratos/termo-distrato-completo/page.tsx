...
export default function TermoDistratoCompletoPage() {
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">Termo de Distrato</h1>
                  <p className="text-sm text-gray-600">Geração de termos de distrato completos</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-900">
                  Termo de Distrato Completo
                </h3>
                <p className="text-blue-800">
                  Gere termos de distrato completos para empresas com contratos existentes,
                  incluindo informações detalhadas sobre o encerramento do vínculo contratual.
                </p>
              </div>
            </div>
          </div>
          ...
          {user?.admin && (
            <>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Geração de Termos de Distrato Completos</h4>
