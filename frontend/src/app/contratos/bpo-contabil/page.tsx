...
export default function BpoContabilPage() {
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">BPO Contábil Completo</h1>
                  <p className="text-sm text-gray-600">Geração de contratos para serviços contábeis</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-900">
                  Contrato BPO Contábil Completo
                </h3>
                <p className="text-blue-800">
                  Gere contratos para serviços de Business Process Outsourcing (BPO) contábil, 
                  incluindo processamento de documentos, conciliações e relatórios financeiros.
                </p>
              </div>
            </div>
          </div>
