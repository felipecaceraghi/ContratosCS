...
export default function BpoFolhaPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">BPO Folha de Pagamento</h1>
                <p className="text-sm text-gray-600">Gerar contratos de BPO Folha de Pagamento</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-900">
                  Contrato BPO Folha de Pagamento
                </h3>
                <p className="text-blue-800">
                  Gere contratos para serviços de Business Process Outsourcing (BPO) de folha de pagamento, 
                  incluindo processamento de salários, benefícios e obrigações trabalhistas.
                </p>
              </div>
            </div>
          </div>
