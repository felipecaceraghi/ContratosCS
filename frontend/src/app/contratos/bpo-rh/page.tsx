...
export default function BpoRhPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">BPO Recursos Humanos</h1>
                <p className="text-sm text-gray-600">Gerar contratos de BPO para Recursos Humanos</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-900">
                  Contrato BPO Recursos Humanos
                </h3>
                <p className="text-blue-800">
                  Gere contratos para serviços de Business Process Outsourcing (BPO) de recursos humanos, 
                  incluindo recrutamento, seleção, treinamento e gestão de pessoas.
                </p>
              </div>
            </div>
          </div>
